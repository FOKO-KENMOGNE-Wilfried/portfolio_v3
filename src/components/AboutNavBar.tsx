...
import InfoCardIcon from "./common/icons/InfoCardIcon";
import TerminalBoxIcon from "./common/icons/TerminalBoxIcon";
...
function AboutNavBar() {
  ...
  const [informationList, setInformationList] = useState<MainObject[]>([
    {
      id: 1,
      name: "Work",
