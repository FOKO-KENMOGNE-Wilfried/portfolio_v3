...
function ContactNavBar(){
    return (
        <div className="w-full md:w-80 md:border-r border-secondary-dark">
            ...
            <div className="pl-4 pt-8 flex items-center md:items-start flex-col gap-6">
                <a href="mailto:fokowilfried7@gmail.com" className="flex items-center text-secondary-dark cursor-pointer hover:text-primary-light w-fit md:w-full gap-4">
                    <MailIcon className="w-6 h-6" />
                    <p>fokowilfried7@gmail.com</p>
                </a>
                <div className="flex items-center text-secondary-dark w-fit md:w-full hover:text-primary-light gap-4">
